...
+ Таблица отметок КП1 в мобильном телефоне
  ...
  <img src="test-cp1-progress-android.png" alt="Отметки КП1 в Android" title="Отметки КП1 в Android" width="400px">
...
+ Таблица отметок участника в мобильном телефоне
  ...
  <img src="test-petrov-progress-android.png" alt="Отметки Ивана Петрова в Android" title="Отметки Ивана Петрова в Android" width="400px">
